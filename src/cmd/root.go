...
func init() {
	...
	rootCmd.PersistentFlags().String("base-url", "https://app.opslevel.com", "The OpsLevel App Url. Overrides environment variable 'OPSLEVEL_APP_URL'")
	...
	viper.BindEnv("base-url", "OPSLEVEL_APP_URL", "OL_APP_URL")
